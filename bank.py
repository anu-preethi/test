...
data = { "accno" : [1001, 1002, 1003, 1004, 1005],
...
def credit(check): 
    ...
    else:  print("your credit amount is low ")
...
def login(): 
    ...
    if i2 in (data["accno"]):  
        ...
        if check == check2:   
            while True:    
                print("\n 1.check ditails \n 2. debit \n 3. credit \n 4. change password \n 5. main Manu ")    
                i4 = int(input("enter what you want :".center(50)))    #check ditails part    
                if i4 == 1:     
                    cheak_ditails(check)     
                    continue    #debit part    
                elif i4 == 2 :     
...
def main(): 
    ...
    while True :  
        print("\n 1. Login \n 2. Signup \n 3. Exit")  
        i1 = int(input("enter what you want login, signup, exit :".center(50)))  #login part  
        if i1 == 1:   
            login()  #signup part   
        elif i1 == 2 :   
            signup()  #exit part  
            ...
            print("."*100)   
            break  
        else:   print(f"wrong enter : {i1}".center(50))
